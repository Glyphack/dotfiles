...
set -l pr_subs create open share
...
complete -c ,g -n "not __fish_seen_subcommand_from $subcmds" -a co         -d "Pick & switch branch (--all every branch, -d delete, -w worktree, - previous)"
...
complete -c ,g -n "not __fish_seen_subcommand_from $subcmds" -a pr         -d "PR: create / open / share"
...
complete -c ,g -n "__fish_seen_subcommand_from co"    -s a -l all -d "Show every branch, local and remote"
...
complete -c ,g -n "__fish_seen_subcommand_from pr; and not __fish_seen_subcommand_from $pr_subs" -a share  -d "Copy PR link and title to clipboard"
